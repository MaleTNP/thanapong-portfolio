    ...
    <div>
      ...
      <div className="relative flex justify-center items-center">
        ...
        <div className="absolute flex flex-col items-center space-y-4 text-2xl text-white">
          <h1 className="">Good day! I'm</h1>
          <button className="">THANAPONG</button>
          <p className="text-center px-8">a developer with a keen interest in Web and Backend development</p>
